#ifndef FORCE_LCAO_K_NEW_H
#define FORCE_LCAO_K_NEW_H
...
class Force_LCAO_k_new : public Force_LCAO_gamma_new
{
  public:
  ...
  private:
    ...
    void ftable_k_new(const bool isforce,
                  const bool isstress,
                  Record_adj& ra,
    ...
    // get the ds, dt, dvnl.
    void allocate_k_new(const Parallel_Orbitals& pv,
                    const int& nks,
    ...
    void cal_foverlap_k_new(const bool isforce,
                        const bool isstress,
                        Record_adj& ra,
                        const psi::Psi<std::complex<double>>* psi,
                        Local_Orbital_Charge& loc,
    ...
    void cal_fvl_dphi_k_new(const bool isforce,
                        const bool isstress,
    ...
    void test_new(double* mm, const std::string& name);
};
